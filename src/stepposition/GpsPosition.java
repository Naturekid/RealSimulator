 ...
 * 
 *
 * 修改部分代码，改为单例模式，增加暂停标志，增加进程休眠和重启的部分
 */
...
//	String gpsout="";
	...
	//单例模式
		private static GpsPosition instance=null;
		private static final String TAG = "GpsPosition";
		...
		public static GpsPosition getInstance() {
			if (instance == null)
			{
				//	instance = new GpsPosition();
				try {
			        throw new Exception();
		        } catch (Exception e) {  
			        Log.e(TAG, "Exception: 必须先初始化GPS实例并启动进程", e); 
			    } 
			}
			return instance;
		}
